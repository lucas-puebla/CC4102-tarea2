...
public class TextCleanerTest {
  ...
  public void turnLowercaseWithAccentsTest() {
    ...
    assertEquals("When applying lowercase() to a String, it should return" 
        + "a lowercase version of the same String even when it has accents"
        , "ármïjêò", actual);
  }
  ...
  public void turnLowercaseWithSymbols() {
    ...
    assertEquals("When applying lowercase() to a symbol, it should return"
        + " the same symol", "!@#$%^&*()", actual);
  }
  ...
  public void replaceAccentedCharactersForNonAccentedCharactersTest() {
    ...
    assertEquals("Accented characters should be replaced by their non-accented"
        + " equivalents",
  ...
  public void removePunctuationTest() {
    ...
    assertEquals("Every punctuation should be removed",
        "hola amigos que tal yo estoy bien", actual);
  }
  ...
  public void stemmerTest() {
    ...
    assertEquals("Similar words should be stemmed to their prefix",
        "amor amor amor", actual);
  }
  ...
  public void cleanTextTest() {
    ...
    assertEquals("The text should be cleaned!",
        "hola que tal como estas", actual);
  }
